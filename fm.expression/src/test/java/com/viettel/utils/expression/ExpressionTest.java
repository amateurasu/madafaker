...
public class ExpressionTest {
    ...
    public void testExpression1() {
        Token[] tokens = new Token[] {new NumberToken(3d), new NumberToken(2d), new OperatorToken(Operator.get('+',
            2))};
    ...
    public void testExpression2() {
        Token[] tokens = new Token[] {new NumberToken(1d), new FunctionToken(Function.get("log")),};
        Expression exp = new Expression(tokens);
    ...
    public void testGetVariableNames1() {
        Token[] tokens = new Token[] {new VariableToken("a"), new VariableToken("b"),
            new OperatorToken(Operator.get('+', 2))};
        Expression exp = new Expression(tokens);
    ...
    public void testCotangent1() {
        Expression e = new ExpressionBuilder("cot(1)").build();
        assertEquals(1 / Math.tan(1), e.evaluate(), 0d);
    }

    @Test
    public void testInvalidCotangent1() {
        assertThrows(ArithmeticException.class, () -> new ExpressionBuilder("cot(0)").build().evaluate());
    }
