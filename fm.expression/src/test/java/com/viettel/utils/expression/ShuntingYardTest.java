...
//
// import com.viettel.ems.expression.Operator;
// import com.viettel.ems.expression.tokenizer.Token;
...
//         Token[] tokens = convertToRPN(expression, null, null, null, true);
...
//         Token[] tokens =
//             convertToRPN(expression, null, null, new HashSet<>(Collections.singletonList("x")), true);
...
//         Token[] tokens = convertToRPN(expression, null, userOperators, null, true);
//         assertNumberToken(tokens[0], 2d);
//         assertNumberToken(tokens[1], 2d);
...
//         Token[] tokens = convertToRPN("1$", null, userOperators, null, true);
